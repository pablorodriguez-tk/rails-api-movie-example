...
movie1 = Movie.create(title: 'The Matrix', gender: 'Action', release_date: Date.new(1999, 3, 31), qualification: 8, director: user1, cast_member: [user2])
movie2 = Movie.create(title: 'Inception', gender: 'Thriller', release_date: Date.new(2010, 7, 16), qualification: 9, director: user2, cast_member: [user2])
